...
async function persistProviderTask(ledger,requestKey,record){try{return await ledger.record(requestKey,record);}catch(error){error.failureStage="AFTER_PROVIDER_RESPONSE_BEFORE_TASK_PERSISTENCE";error.failureClass="LOCAL_PERSISTENCE_FAILURE";error.retryability="REVIEW_REQUIRED";throw error;}}
