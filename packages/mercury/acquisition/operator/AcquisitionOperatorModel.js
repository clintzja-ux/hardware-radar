...
export function createAcquisitionOperatorModel({mode=ACQUISITION_MODES.PLAN,policy,spentTodayUsd=0,plan=null,runs=[],paidTransportReachable=false}={}){
