 ...
 */
export function createProductionAmazonProductsDiscoverySourceOwner({ sourceOwner=null, atlas=null, destinationRepository=null, historicalRepository=null, boundedRepository=null, artifactRepository=null, actionRepository, taskLedger, executionRepository, consumptionRepository, resultRepository=null, rightsRegistry=null, spendResolver=null, boundedSpendProgressionResolver=null, credentialLoader, httpTransport, acquisitionService, runLock, stateRoot, executionService=null, now = () => new Date().toISOString() } = {}) {
  if(!sourceOwner){
    ...
    const taskOwner=createProductionDataForSeoTaskOwner({operation:"AMAZON_PRODUCTS",stateRoot,credentialLoader,httpTransport,acquisitionService,executionRepository,consumptionRepository,runLock,boundedSpendProgressionResolver,now});
