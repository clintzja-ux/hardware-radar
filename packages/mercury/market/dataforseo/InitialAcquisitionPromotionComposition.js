...
export function composeInitialAcquisitionPromotionAssessment({records,requestedAtlasProductId,retentionAudit=null,sellersProposalEnvelope=null,atlasProduct=null}={}){
  ...
  const direct=retentionAudit.governance.lineage.identityLineageType==="DIRECT_PRODUCTS_STRONG_IDENTITY";
  if(retentionAudit.atlasProductId!==requestedProduct||retentionAudit.sellersTaskId!==sellersTaskId||(direct?retentionAudit.productInfoTaskId!=null:retentionAudit.productInfoTaskId!==retentionAudit.governance.lineage.productInfoTaskId))throw new Error("INITIAL_ACQUISITION_RETENTION_LINEAGE_CONFLICT");
