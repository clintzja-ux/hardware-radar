...
const mk=(id,currency,condition,retailerId="R1")=>({observationId:id,atlasProductId:"ram_x",retailerId,marketplace:"market",observationTime:`2026-01-0${id.at(-1)}T00:00:00Z`,validationStatus:"PASS",compliance:{licenseContext:"INDEPENDENT_SOURCE"},offer:{price:10,currency,condition}});
