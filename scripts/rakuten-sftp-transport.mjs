...
function printIntegrity(value,write=(...args)=>console.log(...args)){if(!value)return;write("Integrity:");write("  stage:                     ",value.integrityStage);write("  rows parsed:               ",value.rowsParsed);write("  product rows parsed:       ",value.productRowsParsed);write("  field counts observed:     ",value.fieldCountsObserved.join(", ")||"NONE");write("  row ordinal:               ",value.rowOrdinal??"NONE");write("  observed field count:      ",value.observedFieldCount??"NONE");write("  trailer count observed:    ",value.trailerCountObserved??"NONE");write("  header timestamp present:  ",value.headerTimestampPresent?"YES":"NO");write("  gzip opened/completed:     ",`${value.gzipOpened?"YES":"NO"}/${value.gzipCompleted?"YES":"NO"}`);}
