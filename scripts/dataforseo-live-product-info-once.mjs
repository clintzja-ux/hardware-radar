...
const acquisition = new DataForSeoAcquisitionService({ client, ledger });

const result = await acquisition.createProductInfoTask({
  dataDocId: "17540895125310173539",
  locationName: "United States",
  languageName: "English"
});

console.log("PRODUCT INFO TASK CREATED");
