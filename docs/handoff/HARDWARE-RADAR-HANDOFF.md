...
- Current Display is not publication authority, and publication authority is not release authority. Mercury's product-scoped current-display candidate/authorization composition revalidates exact current facts and claim strength; Sentinel accepts that authority for a static artifact only through verifiable binding. Item-price ordering is legitimate when comparison-eligible and never implies delivered-cost superiority.
