...
- Keep manual publisher observations and automated commerce feeds as distinct Mercury source lanes. A source-specific weak item-price display may be public-display eligible while condition remains unknown, but only separately comparison-eligible offers may participate in lower-price comparison or Cheapest; private operator provenance and unknown costs never enter the public artifact.
