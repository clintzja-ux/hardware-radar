...
- Treat retailer commerce-data sources and affiliate routing as replaceable capabilities. Losing an affiliate relationship or source must not invalidate Atlas product or retailer identity, Mercury `RetailerDestination` identity, comparison semantics, or approved alternate/manual acquisition paths; affiliate state must never influence Cheapest or Picks. See ADR-060.
