...
- After formal completion of the fixed 100-product RAM stage, the first post-100 production-connection gate is a certified, fail-closed static publication release control. This delivery choice preserves the canonical hybrid acquisition doctrine in the [product evolution document](../products/HARDWARE-RADAR-PRODUCT-EVOLUTION.md): independent market intelligence and retailer/affiliate/commerce current-display inputs are complementary, separately governed Mercury lanes and neither inherits the other's authority. Gateway is not required for that initial static canary and must not become an on-demand price-acquisition proxy; Beacon may follow independently because existing GA4 measurement is sufficient for the first bounded experiment. See the [post-100 production connection plan](../products/HARDWARE-RADAR-POST-100-PRODUCTION-CONNECTION.md).
