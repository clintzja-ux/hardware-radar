...
B-001 maps all 22 canonical RAM products to the existing exact-MPN Mercury path. B-002 fixture-certified and B-002A applied the exact operator-authorized `ACTIVE/READY` revisions for six new members of the representative cohort. Reviewer `human:Clinton_Ramsook` is recorded; the original Corsair anchor remains byte-for-byte unchanged; the other 15 launch records remain outside the batch. Seven products are lifecycle-ready and are constructed as exact-MPN `PRODUCTS` candidates. B-003 reconciled mixed dry-run output, and B-004 fixture-certified exact-product inspection/PREPARE selection. The operator created exactly one governed Crucial `CP2K16G56C46U5` PRODUCTS task (`09011702-2304-0179-0000-c977c7e8a824`) for `$0.001`, then retrieved its result at zero additional cost. Resolution is `RECOMMENDED` with exact MPN, score 88, no contradictions, and proposal `enrich_de39dafdbbad923d0cbb2dc6`. B-006A now fixture-certifies one shared UTC-day actual-spend calculation across PRODUCTS, PRODUCT_INFO, SELLERS, and historical refresh; every paid PREPARE composes it, and execution requires an exact ledger snapshot match under the acquisition lock before transport. The old unconsumed PRODUCT_INFO authorization `enrichauth_9ff2d3fe9a30a6c5ed222b30` remains immutable but is operationally unusable because it bound incorrect `spentTodayUsd: 0`; a fresh production PREPARE is required. Current-day governed spend is `$0.001`; total durable governed acquisition spend is `$0.006`. The operator-observed provider balance `$0.991` as of 2026-09-01 is contextual only, not canonical Mercury spend authority. No Crucial PRODUCT_INFO task, evidence, history, canonical observation, review, E2S, publication, Current Price, Cheapest, or Pick authority exists.
