...
The committed 100-stage artifact currently resolves to stage digest `470dfadbdb8670de3566826d33eb74cb9d97a1ca6e14bf8b3fac71101ecaaf21`; current Amazon Products eligibility remains 65 and candidate-pool digest `ed24651aa03dc0d71bb2cd692d8fb25218d08a15240e7d216998655b1ade56cb`. No repository policy governs the first 100-stage `requestedCanarySize`, so status is `SELECTOR_CERTIFIED / CANARY_SIZE_REQUIRES_OPERATOR_STAGE_POLICY`. Size 5/8/10 outputs remain simulations only; no proposal artifact, PREPARE, or authority exists. The next decision is the explicit size, never manual member replacement.
