...
After checkpointing this P1, perform a zero-provider second 100-stage Amazon Products selector proposal at requested size 24 using selector V1. Stop before PREPARE; selection grants no authority.
