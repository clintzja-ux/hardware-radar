...
Implement and fixture-certify the zero-provider selector-proposal → PREPARE direct-binding P1 inside the existing selector and identity-discovery PREPARE composition. Do not select the next members, create a new stage owner, PREPARE, authorize, or perform paid work in that increment.
