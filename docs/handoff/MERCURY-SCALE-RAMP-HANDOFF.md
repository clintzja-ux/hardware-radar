...
The direct proposal PREPARE/INSPECT boundary is now production-operationally proven. At cycle `2026-09-17T15:39:53.1264369Z`, fresh validation created immutable plan `mer_iddiscplan_1286590438ea302f73c02e4c` with binding digest `1286590438ea302f73c02e4cc94d6a9d8910516c6be055133f2908a1c3799772` and cohort digest `85a36ad669d5683e963fca5f7ea27cb53ab862d80e87ef3f51d94fdf190cc5d2`. INSPECT reports `SELECTOR_PROPOSAL`, complete provenance, selector-membership equivalence `true`, requested 24 / READY 24 / blocked 0, maximum 24 tasks / `$0.0360`, and zero retries. Current spend remains `$0.0120` against `$0.0500`, leaving `$0.0380`. The plan is `NOT_AUTHORIZED`; no run, provider call, paid task, spend, result, evidence, history, or downstream authority exists. The first-canary plan/run and its historical legacy-input semantics remain unchanged. Checkpoint this plan, then separately review bounded parent authorization; do not START.
...
Checkpoint plan `mer_iddiscplan_1286590438ea302f73c02e4c`. After that checkpoint, separately review whether to create its bounded parent authorization, then stop before START.
