...
# Hardware Radar Product Vision & Strategy
...
Hardware Radar exists to help people make confident hardware buying decisions through accurate technical knowledge, trustworthy recommendations, and current market intelligence.
...
3. Where can I buy it today at a fair price?
...
Users struggle because information is fragmented across manufacturer pages, retailer listings, reviews, and videos.

Hardware Radar combines:
...
into one trustworthy experience.
...
## 2. Mercury
Market intelligence and retailer observations.
...
We do not compete primarily on page count.
...
Revenue should be a consequence of user trust.

Primary revenue:

- affiliate programs
- future premium tools
- enterprise APIs (long term)
...
## Phase 3
Best hardware across major categories.

## Phase 4
Intelligent PC planning.

## Phase 5
Conversational Hardware Advisor.
...
Every public page must be traceable to:
...
2. Does it improve buying decisions?
3. Does it fit the architecture?
4. Can it be maintained?
5. Is it worth delaying the MVP?

If "no" to most questions, defer it.
...
2. Launch the RAM MVP.
3. Expand hardware coverage.
4. Improve recommendations.
5. Introduce conversational intelligence.
