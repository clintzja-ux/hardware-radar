...
| 15 | `DDR4-DESKTOP-SINGLE-16GB` | `KVR32N22S8/16` | `REPLACEMENT_CANDIDATE_RECOMMENDED` | Crucial `CT16G4DFRA32A` | 16GB 1×16GB DDR4-3200 CL22, 1.2V | [Crucial](https://www.crucial.com/memory/ddr4/ct16g4dfra32a) | Best Buy: `VERIFIED_CURRENT_LISTING`; Adorama: `VERIFIED_CURRENT_LISTING` | Strong two-retailer overlap for a mainstream upgrade module. `READY_FOR_OPERATOR_REVIEW` |
| 16 | `DDR4-DESKTOP-SINGLE-32GB` | `KVR32N22D8/32` | `KEEP` | Kingston `KVR32N22D8/32` | 32GB 1×32GB DDR4-3200 CL22 | [Kingston](https://www.kingston.com/en/memory/search?partId=KVR32N22D8%2F32) | Best Buy index: `VERIFIED_CURRENT_LISTING` | Crucial alternative is explicitly under an EOL path; current Kingston record is safer. `READY_FOR_OPERATOR_REVIEW` |
| 17 | `SODIMM-DDR4-SINGLE-8GB` | `KVR32S22S8/8` | `REPLACEMENT_CANDIDATE_RECOMMENDED` | Crucial `CT8G4SFRA32A` | 8GB 1×8GB DDR4-3200 CL22 SODIMM | [Crucial](https://eu.crucial.com/memory/ddr4/ct8g4sfra32a/ct26084342) | Best Buy: `VERIFIED_CURRENT_LISTING`; Adorama: `RECENT_OR_INDEXED_LISTING` | Better observed portfolio overlap for an entry laptop upgrade. `READY_FOR_OPERATOR_REVIEW` |
| 18 | `SODIMM-DDR4-SINGLE-16GB` | `KVR32S22S8/16` | `KEEP` | Kingston `KVR32S22S8/16` | 16GB 1×16GB DDR4-3200 CL22 SODIMM | [Kingston](https://www.kingston.com/en/memory/search?partid=KVR32S22S8%2F16) | `NOT_FOUND` | Preserves manufacturer diversity within SODIMM and exact current identity. `READY_FOR_OPERATOR_REVIEW` |
...
| 20 | `SODIMM-DDR4-KIT-32GB` | `KF432S20IBK2/32` | `REPLACEMENT_CANDIDATE_RECOMMENDED` | G.SKILL `F4-3200C22D-32GRS` | 32GB 2×16GB DDR4-3200 CL22 SODIMM | [G.SKILL](https://www.gskill.com/specification/2/197/1594019162/F4-3200C22D-32GRS-Specification) | Best Buy marketplace: `VERIFIED_CURRENT_LISTING` | Adds a distinct laptop-focused brand with a current exact listing. `READY_FOR_OPERATOR_REVIEW` |
| 21 | `SODIMM-DDR5-SINGLE-16GB` | `KVR56S46BS8-16` | `REPLACEMENT_CANDIDATE_RECOMMENDED` | Crucial `CT16G56C46S5` | 16GB 1×16GB DDR5-5600 46-45-45 SODIMM | [Crucial](https://www.crucial.com/memory/ddr5/ct16g56c46s5) | Best Buy marketplace: `VERIFIED_CURRENT_LISTING`; Adorama: `VERIFIED_CURRENT_LISTING` | Two-retailer overlap and a mainstream laptop-upgrade identity. `READY_FOR_OPERATOR_REVIEW` |
| 22 | `SODIMM-DDR5-SINGLE-32GB` | `KVR56S46BD8-32` | `REPLACEMENT_CANDIDATE_RECOMMENDED` | Corsair `CMSX32GX5M1A5600C48` | 32GB 1×32GB DDR5-5600 48-48-48-90 SODIMM | [Corsair](https://www.corsair.com/es/es/p/memory/cmsx32gx5m1a5600c48/vengeance-ddr5-sodimm-32gb-1x32gb-ddr5-5600mts-cl48-cmsx32gx5m1a5600c48) | Best Buy: `VERIFIED_CURRENT_LISTING` | Adds a recognizable fourth SODIMM manufacturer with local pickup visibility. `READY_FOR_OPERATOR_REVIEW` |
| 23 | `SODIMM-DDR5-KIT-32GB` | `KF556S40IBK2-32` | `REPLACEMENT_CANDIDATE_RECOMMENDED` | G.SKILL `F5-5600S4040A16GX2-RS` | 32GB 2×16GB DDR5-5600 40-40-40-89 SODIMM | [G.SKILL](https://www.gskill.com/tw/specification/57/385/1683883142/F5-5600S4040A16GX2-RS-Specification) | Best Buy marketplace: `VERIFIED_CURRENT_LISTING` | Distinct 32GB performance-laptop kit and improved category diversity. `READY_FOR_OPERATOR_REVIEW` |
| 24 | `SODIMM-DDR5-KIT-64GB` | `KF556S40IBK2-64` | `KEEP` | Kingston `KF556S40IBK2-64` | 64GB 2×32GB DDR5-5600 CL40 SODIMM | [Kingston](https://www.kingston.com/datasheets/KF556S40IBK2-64.pdf) | Best Buy: `VERIFIED_CURRENT_LISTING` | Strong high-capacity kit visibility and useful Kingston representation. `READY_FOR_OPERATOR_REVIEW` |
...
| Category | Slots represented | `READY_FOR_OPERATOR_REVIEW` | `NEEDS_MORE_EVIDENCE` | `REJECTED` | Unresolved |
|---|---:|---:|---:|---:|---:|
...
Fixture certification is not Atlas admission. The production manifest remains at one RAM product. D-002A establishes reviewed canonical brand records for Crucial, G.SKILL, Kingston, and TeamGroup alongside the unchanged Corsair record, so every fixture brand now resolves through the Atlas brand registry. The 21 product records still require separate operator authorization before source-controlled Atlas admission.
