...
Current classification: `TWO_PLAN_P1A_TERMINAL / NO_SYSTEMIC_STOP / PER_EVIDENCE_HISTORICAL_ADMISSION_ISOLATION_CLOSED / LONGITUDINAL_REASSESSMENT_REQUIRED`.
