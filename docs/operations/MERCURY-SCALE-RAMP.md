...
The exact proposal has now passed fresh selector replay and member revalidation and was prepared through the existing Products identity-discovery owner using [100-product-first-amazon-products-canary-cohort.json](../../config/mercury/scale-ramp/100-product-first-amazon-products-canary-cohort.json). Plan `mer_iddiscplan_420db0ac62da881c02c8c61d` (`420db0ac62da881c02c8c61dcfa73927d1a03f6d0b72c27f9b90d2c195281ef5`) is requested 8 / READY 8 / blocked 0, `NOT_AUTHORIZED`, and `NOT_STARTED`. PREPARE persisted the plan and eight expected zero-authority Amazon acceptance preparation artifacts while preserving zero tasks, executions, results, evidence, history, provider calls, and spend. The next separate action is human review of this exact envelope, authorization only, and STOP before START.
