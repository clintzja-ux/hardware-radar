...
That P1 is now `IMPLEMENTED / FIXTURE-CERTIFIED / PRODUCTION-SHAPED-CERTIFIED` under [IC-MERCURY-SCALE-RAMP-PROPOSAL-PREPARE-001](../implementation%20Contracts/IC-MERCURY-SCALE-RAMP-PROPOSAL-PREPARE-001%20-%20Selector%20Proposal%20to%20PREPARE%20Direct%20Binding.md). The direct CLI consumes the immutable review proposal, derives exact members/source/operation, revalidates current owners, and stores complete provenance inside the existing plan binding. INSPECT exposes that lineage. Legacy plans are not rewritten. No production proposal, PREPARE, authorization, task, run, or spend was created. Current gate is `READY_FOR_SECOND_100_STAGE_SLICE_SELECTION`.

The zero-authority second-slice selector result is [100-product-second-amazon-products-slice-review.json](../../config/mercury/scale-ramp/100-product-second-amazon-products-slice-review.json). Fresh readiness produced 60 destination-ready discovery candidates, but three were already-paid unresolved first-slice operations. Applying reconstructable first-slice history as the required non-repurchase exclusion left 57 candidates (`214b1f7bc2baf7839e6d6b0011d6872ece3c6510f3c76c37619cfae8641a81b3`). Selector V1 chose the exact 24 in the artifact (`19814edfccd81e2f8990473c515faa032b8553f5ee4f10befd82e9d531eebe0b`) with zero prior-slice overlap. Validated proposal identity is `mer_scaleproposal_d0bb1c3878f5673e3ead18c0` / `d0bb1c3878f5673e3ead18c0849d19db11fd01d8b5459e6f96eb5a7835c3e878`. Current spend `$0.0120` plus the informational 24-task maximum `$0.0360` would total `$0.0480`; this is not a reservation or authorization. Do not create a second cohort file. After checkpointing, use the proposal directly for PREPARE, inspect the resulting plan, and stop before authorization.
