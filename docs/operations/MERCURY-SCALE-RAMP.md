...
|---|---|---|
| P0 before 25 | None | — |
| P1 before next larger 100-stage slice | Direct selector-proposal → identity-discovery PREPARE binding; current manual cohort-file reconstruction loses direct proposal provenance even though independent reconciliation kept the first canary safe | Existing selector + identity-discovery PREPARE composition |
